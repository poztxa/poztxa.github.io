            ...
            e.onScroll = function(e) {
              if(e.stickySidebar.is(":visible"))
                if(i("body").width() < e.options.minWidth) d(); 
                  ...
                  var r = i(document).scrollTop(), c = "static";
                  if (r >= e.sidebar.offset().top + (e.paddingTop - e.options.additionalMarginTop)) {
                    var p, b = e.paddingTop + t.additionalMarginTop, l = e.paddingBottom + e.marginBottom + t.additionalMarginBottom, 
                    f = e.sidebar.offset().top, h = e.sidebar.offset().top + (n = e.container, s = n.height(), n.children().each(function(){ s = Math.max(s, i(this).height())}), s), 
                    g = 0 + t.additionalMarginTop;

                    var S = e.stickySidebar.outerHeight() + b + l < i(window).height();
...
$(document).ready(function() {
  console.log("Theia Sticky Sidebar Initialized");  // Untuk debugging
  fixedSidebarIfy(); // Jalankan fungsi sticky sidebar
});
